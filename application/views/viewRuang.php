...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('ruang/ajax_list')?>",
            "type": "POST"
        },
        "columns" :[
            {"data" : "nama_ruang"},
...
function edit_data(id)
{
    ...
    $.ajax({
        url : "<?php echo base_url('ruang/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo base_url('ruang/ajax_add')?>";
    } else if(save_method == 'update'){
        url = "<?php echo base_url('ruang/ajax_update')?>";
    }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Form Ruang</h3>
            </div>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nama_ruang" placeholder="Nama Ruangan" class="form-control" type="text">
